...
> 배포는 변경 크기와 무관하게 항상 **High 리스크**로 취급합니다 (AGENTS.md 참고) — 되돌리기 어렵기 때문입니다.
...
- [ ] `toon-reviewer` 서브에이전트 실행 → "배포 가능" 판정 확인
- [ ] 보완 필요 항목이 있으면 해결 후 재실행

## 4. 기록

- [ ] `AGENTS.md` Part 4(트러블슈팅 로그) 업데이트 (해결한 문제 있으면)
